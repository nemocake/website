...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:wn,depthTest:!1,depthWrite:!1})}function yc(){return new xn({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:kr(),fragmentShader:`
		...
		`,blending:wn,depthTest:!1,depthWrite:!1})}function Ec(){return new xn({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:kr(),fragmentShader:`
	...
	`}class Xh extends gn{constructor(t=1,e={}){super(t,t,e),this.isWebGLCubeRenderTarget=!0;const i={width:t,height:t,depth:1},s=[i,i,i,i,i,i];this.texture=new Ch(s),this._setTextureOptions(e),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(t,e){this.texture.type=e.type,this.texture.colorSpace=e.colorSpace,this.texture.generateMipmaps=e.generateMipmaps,this.texture.minFilter=e.minFilter,this.texture.magFilter=e.magFilter;const i={uniforms:{tEquirect:{value:null}},vertexShader:`
...
`].filter(gs).join(`
`)),a=No(a),a=Ic(a,e),a=Uc(a,e),o=No(o),o=Ic(o,e),o=Uc(o,e),a=Nc(a),o=Nc(o),e.isRawShaderMaterial!==!0&&(x=`#version 300 es
...
`)+`
`+m);const v=x+p+a,E=x+m+o,w=Pc(s,s.VERTEX_SHADER,v),T=Pc(s,s.FRAGMENT_SHADER,E);s.attachShader(y,w),s.attachShader(y,T),e.index0AttributeName!==void 0?s.bindAttribLocation(y,0,e.index0AttributeName):e.morphTargets===!0&&s.bindAttribLocation(y,0,"position"),s.linkProgram(y);function C(P){if(n.debug.checkShaderErrors){const O=s.getProgramInfoLog(y)||"",Y=s.getShaderInfoLog(w)||"",W=s.getShaderInfoLog(T)||"",F=O.trim(),H=Y.trim(),V=W.trim();let J=!0,tt=!0;if(s.getProgramParameter(y,s.LINK_STATUS)===!1)if(J=!1,typeof n.debug.onShaderError=="function")n.debug.onShaderError(s,y,w,T);else{const lt=Lc(s,w,"vertex"),St=Lc(s,T,"fragment");Wt("THREE.WebGLProgram: Shader Error "+s.getError()+" - VALIDATE_STATUS "+s.getProgramParameter(y,s.VALIDATE_STATUS)+`
...
gl_FragColor.a *= ${c};
${f}`)}},e}function Bx(n,t){const e=n.length,i=new Hr(1,12),s=new Float32Array(e),r=new Float32Array(e),a=new Float32Array(e),o=new Float32Array(e),l=new Float32Array(e*3),c=new Float32Array(e);for(let x=0;x<e;x++){const v=n[x];s[x]=v.alpha,r[x]=v.driftPhase,a[x]=v.driftSpeed,o[x]=v.driftAmp,l[x*3+0]=v.driftAxis.x,l[x*3+1]=v.driftAxis.y,l[x*3+2]=v.driftAxis.z,c[x]=v.anim??0}i.setAttribute("aInstAlpha",new kn(s,1)),i.setAttribute("aDriftPhase",new kn(r,1)),i.setAttribute("aDriftSpeed",new kn(a,1)),i.setAttribute("aDriftAmp",new kn(o,1)),i.setAttribute("aDriftAxis",new kn(l,3)),i.setAttribute("aAnimKind",new kn(c,1));const h=new Vr({color:16777215,transparent:!0,depthWrite:!1,side:sn}),f=du(h);L.gpuDriftUniforms.push(f);const u=new zf(i,h,e);u.frustumCulled=!1,u.name="circle-instances";const d=new re,g=new R,y=new Ln,p=new R,m=new kt;for(let x=0;x<e;x++){const v=n[x];g.set(v.cx,v.cy,v.zOff),p.set(v.r,v.r,1),d.compose(g,y,p),u.setMatrixAt(x,d),m.set(v.color),u.setColorAt(x,m)}u.instanceMatrix.needsUpdate=!0,u.instanceColor&&(u.instanceColor.needsUpdate=!0),t.add(u),L.instancedMeshes.push(u)}function zx(n){const t=n.float(0,1);if(t<.55)return new R(0,1,0);if(t<.75)return new R(1,0,0);if(t<.9)return new R(0,0,1);const e=new R(n.float(-1,1),n.float(-1,1),n.float(-1,1));return e.normalize(),e}function Ba(n,t){return n?Array.isArray(n)?new R(n[0],n[1],n[2]):new R(n.x??0,n.y??0,n.z??0):zx(t)}function Gx(n,t,e,i,s,r,a){const o=n.alpha??1;switch(n.type){case Ke.LINE:{const l=new ge().setFromPoints([new R(t(n.x1),e(n.y1),0),new R(t(n.x2),e(n.y2),0)]);return new Hn(l,s(n.color,o))}case Ke.POLYLINE:{const l=n.points.map(([h,f])=>new R(t(h),e(f),0)),c=new ge().setFromPoints(l);return new Hn(c,s(n.color,o))}case Ke.POLYGON:{const l=[...n.points,n.points[0]].map(([h,f])=>new R(t(h),e(f),0));if(n.fill){const h=new Nh(n.points.map(([d,g])=>new ut(t(d),e(g)))),f=new Jo(h),u=new He(f,r(n.fill,o*.85));if(n.color&&n.width>0){const d=new ge().setFromPoints(l);u.add(new Hn(d,s(n.color,o)))}return u}const c=new ge().setFromPoints(l);return new Hn(c,s(n.color,o))}case Ke.RECT:{const l=t(n.x),c=e(n.y),h=t(n.x+n.w),f=e(n.y+n.h);if(n.fill){const d=i(n.w),g=i(n.h),y=new Ls(d,g),p=new He(y,r(n.fill,o*.85));if(p.position.set(t(n.x+n.w/2),e(n.y+n.h/2),0),n.color&&n.width>0){const m=new ge().setFromPoints([new R(-d/2,-g/2,0),new R(d/2,-g/2,0),new R(d/2,g/2,0),new R(-d/2,g/2,0),new R(-d/2,-g/2,0)]);p.add(new Hn(m,s(n.color,o)))}return p}const u=new ge().setFromPoints([new R(l,c,0),new R(h,c,0),new R(h,f,0),new R(l,f,0),new R(l,c,0)]);return new Hn(u,s(n.color,o))}case Ke.CIRCLE:{const l=t(n.cx),c=e(n.cy),h=i(n.r);if(n.fill){const g=new Hr(h,12),y=new He(g,r(n.fill,o));return y.position.set(l,c,0),y}const f=24,u=[];for(let g=0;g<=f;g++){const y=g/f*Math.PI*2;u.push(new R(l+Math.cos(y)*h,c+Math.sin(y)*h,0))}const d=new ge().setFromPoints(u);return new Hn(d,s(n.color,o))}case Ke.TEXT:return Vx(n,t,e,i)}return null}function Vx(n,t,e,i){const s=n.size,r=String(n.content),a=Math.max(4,s*.4),l=document.createElement("canvas").getContext("2d"),c=n.italic?"italic ":"",h=n.weight&&n.weight>=600?"bold ":"";l.font=`${c}${h}${s}px ${n.font}`;const f=l.measureText(r),u=Math.max(8,f.width),d=s*1.4,g=Math.ceil(u+a*2),y=Math.ceil(d+a*2),p=document.createElement("canvas"),m=2;p.width=g*m,p.height=y*m;const x=p.getContext("2d");x.scale(m,m),x.fillStyle=n.color,x.font=l.font,x.textAlign="center",x.textBaseline="middle",x.fillText(r,g/2,y/2);const v=new Wf(p);v.minFilter=Ae,v.magFilter=Ae,v.colorSpace=qe;const E=new bh({map:v,transparent:!0,opacity:n.alpha??1,depthWrite:!1}),w=new Ah(E),T=i(g),C=i(y);w.scale.set(T,C,1);const S=n.align==="left"?i(u/2):n.align==="right"?-i(u/2):0,A=n.baseline==="top"?-i(d/2):n.baseline==="bottom"||n.baseline==="alphabetic"?i(d/4):0;return w.position.set(t(n.x)+S,e(n.y)+A,0),w}function Hx(n){n&&($n.remove(n),n.traverse(t=>{var e;if(t.geometry&&t.geometry.dispose(),t.material){const i=Array.isArray(t.material)?t.material:[t.material];for(const s of i)(e=s.map)==null||e.dispose(),s.dispose()}}))}function Pe(){const n=L._lastMode??"single",t=L.grid3d.enabled?"grid":"single",e=n!==t;Hx(L.cuboidGroup);const i=Kr();L.grid3d.enabled?(L.cuboidGroup=Ux(L.masterSeed,i),$n.add(L.cuboidGroup),Wx(L.cuboidGroup)):(L.cuboidGroup=Ax(L.masterSeed,i),$n.add(L.cuboidGroup),e&&kx()),L._lastMode=t,ul(),fl(i),window.history.replaceState(null,"",`#SEED=${Ms(L.masterSeed)}`),nv()}function kx(){const{w:n,h:t,d:e}=L.size,i=Math.sqrt((n/2)**2+(t/2)**2+(e/2)**2),s=Re.fov*Math.PI/180,r=2*Math.atan(Math.tan(s/2)*Re.aspect),a=i/Math.tan(s/2),o=i/Math.tan(r/2),l=Math.max(a,o)*1.5,c=15*Math.PI/180,h=10*Math.PI/180;Re.position.set(Math.sin(c)*Math.cos(h)*l,Math.sin(h)*l,Math.cos(c)*Math.cos(h)*l),ye.target.set(0,0,0),ye.update()}function Wx(n){const t=n.userData.gridBounds;if(!t)return;const{totalW:e,totalD:i,maxHeight:s}=t,r=Math.sqrt((e/2)**2+(i/2)**2)+s/2,a=Re.fov*Math.PI/180,o=2*Math.atan(Math.tan(a/2)*Re.aspect),l=r/Math.tan(a/2),c=r/Math.tan(o/2),h=Math.max(l,c)*1.35;ye.maxDistance=Math.max(ye.maxDistance,h*1.8);const f=25*Math.PI/180;Re.position.set(0,Math.sin(f)*h+s*.25,Math.cos(f)*h),ye.target.set(0,s*.4,0),ye.update()}function fl(n){const t=document.getElementById("seed-display");if(t){const i=L.grid3d.enabled?`grid ${L.grid3d.rows}×${L.grid3d.cols}`:`h: ${L.size.h.toFixed(1)}`;t.textContent=`MASTER ${Ms(L.masterSeed)} · palette: ${n.name} · bg: ${L.bgKey} · ${i} · density: ${L.density.toFixed(2)} · vocab: ${Qx()} · elements: ${L.animatedElements.length}`}const e=document.getElementById("seed-value");e&&(e.textContent=Ms(L.masterSeed))}function Fr(n){for(let t=0,e=L.animatedElements.length;t<e;t++){const i=L.animatedElements[t],s=i.userData;if(!s.basePos)continue;const r=Math.sin(n*s.driftSpeed+s.driftPhase)*s.driftAmp;i.position.copy(s.basePos).addScaledVector(s.driftAxis,r)}for(let t=0,e=L.gpuDriftUniforms.length;t<e;t++)L.gpuDriftUniforms[t].value=n}const ds=20,Xx=6;function pu(n,t,e){const i=new Jh({antialias:!0,preserveDrawingBuffer:!0,alpha:!1});return i.setSize(n,t),i.setPixelRatio(e),i}function mu(n,t){const e=new Ze(Re.fov,n/t,Re.near,Re.far);return e.position.copy(Re.position),e.quaternion.copy(Re.quaternion),e.updateMatrixWorld(),e}async function gu(){if(!L.isExporting){L.isExporting=!0,Kn("RENDERING PNG…"),await br();try{const{width:n,height:t}=al(),e=pu(n,t,2),i=mu(n,t);Fr(yu.getElapsedTime()),e.render($n,i);const s=e.domElement.toDataURL("image/png");e.dispose(),await xu({format:"png",content:s,filenameSuffix:"-3d",mode:"3d-png"})}catch(n){Kn(`SAVE FAILED: ${n.message}`,!0)}L.isExporting=!1}}async function _u(){if(L.isExporting)return;L.isExporting=!0;const n=Math.floor(ds*Xx),t=L.autoRotate;Kn(`ENCODING GIF${t?" · ROTATING":""} · 0/${n}`),await br();try{const{width:e,height:i}=ux(),s=pu(e,i,1),r=mu(e,i),a=ye.target.clone(),o=new Io().setFromVector3(r.position.clone().sub(a)),l=document.createElement("canvas");l.width=e,l.height=i;const c=l.getContext("2d",{willReadFrequently:!0}),h=x=>{if(!t)return;const v=Math.PI*2/60*ye.autoRotateSpeed,E=x/ds,w=o.clone();w.theta-=v*E;const T=new R().setFromSpherical(w);r.position.copy(a).add(T),r.up.copy(Re.up),r.lookAt(a)};Kn(`ENCODING GIF${t?" · ROTATING":""} · SAMPLING…`),await br();const f=5,u=e*i*4,d=new Uint8ClampedArray(u*f);for(let x=0;x<f;x++){const v=Math.floor(x*(n-1)/Math.max(1,f-1));Fr(v/ds),h(v),s.render($n,r),c.drawImage(s.domElement,0,0);const E=c.getImageData(0,0,e,i).data;d.set(E,x*u)}const g=Z0(d,256,{format:"rgba4444"}),y=tx();for(let x=0;x<n;x++){Fr(x/ds),h(x),s.render($n,r),c.drawImage(s.domElement,0,0);const v=c.getImageData(0,0,e,i),E=J0(v.data,g,"rgba4444");y.writeFrame(E,e,i,{palette:g,delay:Math.round(1e3/ds),transparent:!1}),x%4===0&&(Kn(`ENCODING GIF${t?" · ROTATING":""} · ${x+1}/${n}`),await br())}y.finish(),s.dispose();const p=y.bytes(),m="data:image/gif;base64,"+Yx(p);await xu({format:"gif",content:m,filenameSuffix:"-3d",mode:"3d-gif"})}catch(e){Kn(`SAVE FAILED: ${e.message}`,!0)}L.isExporting=!1}function Yx(n){let e="";for(let i=0;i<n.length;i+=32768)e+=String.fromCharCode.apply(null,n.subarray(i,Math.min(i+32768,n.length)));return btoa(e)}function br(){return new Promise(n=>requestAnimationFrame(()=>n()))}async function xu({format:n,content:t,filenameSuffix:e}){const i=zr(L.paletteName),s=nh(i,L.paletteTone),r=Ms(L.masterSeed),a=String(e).replace(/[^a-zA-Z0-9-]/g,""),o=Ss(i)?`-${L.paletteTone}`:"",l=`score-${r}-${s.name}${o}${a}.${n}`,c=await qx(n,t);Kx(c,l),Kn(`DOWNLOADED → ${l}`)}async function qx(n,t){return n==="svg"?new Blob([t],{type:"image/svg+xml"}):await(await fetch(t)).blob()}function Kx(n,t){const e=URL.createObjectURL(n),i=document.createElement("a");i.href=e,i.download=t,document.body.appendChild(i),i.click(),document.body.removeChild(i),setTimeout(()=>URL.revokeObjectURL(e),1500)}async function Zx(){}let Kc;function Kn(n,t=!1){const e=document.getElementById("toast");e&&(e.textContent=n,e.style.background=t?"#a01010":"#1a1a1a",e.classList.add("show"),clearTimeout(Kc),Kc=setTimeout(()=>e.classList.remove("show"),2400))}function dl(){const n=Math.max(L.size.w,L.size.h,L.size.d);ye.maxDistance=Math.max(14,n*5)}function $x(n,t){const e=n==="h",r=Math.max(e?ol:Rs,Math.min(e?ll:Cs,t));if(Math.abs(L.size[n]-r)<.001)return;L.size[n]=r;const a=n==="h"?tl:n==="w"?el:nl;localStorage.setItem(a,String(r)),dl(),Pe()}function pl(n,t){const e=document.getElementById(n),i=document.getElementById(`${n}-value`);e&&(e.value=L.size[t].toFixed(1),i&&(i.textContent=L.size[t].toFixed(1)),e.addEventListener("input",()=>{i&&(i.textContent=parseFloat(e.value).toFixed(1))}),e.addEventListener("change",()=>{$x(t,parseFloat(e.value))}))}pl("size-height","h");pl("size-width","w");pl("size-depth","d");dl();function Zc(){localStorage.setItem(lu,JSON.stringify({rows:L.grid3d.rows,cols:L.grid3d.cols}))}function $c(n){["size-height","size-width","size-depth"].forEach(t=>{const e=document.getElementById(t);e&&(e.disabled=!n)})}{const n=document.getElementById("grid3d-enabled"),t=document.getElementById("grid3d-rows"),e=document.getElementById("grid3d-cols");n&&(n.checked=L.grid3d.enabled,n.addEventListener("change",()=>{L.grid3d.enabled=n.checked,localStorage.setItem(ox,L.grid3d.enabled?"1":"0"),$c(!L.grid3d.enabled),Pe()})),t&&(t.value=String(L.grid3d.rows),t.addEventListener("change",()=>{L.grid3d.rows=parseInt(t.value,10),Zc(),L.grid3d.enabled&&Pe()})),e&&(e.value=String(L.grid3d.cols),e.addEventListener("change",()=>{L.grid3d.cols=parseInt(e.value,10),Zc(),L.grid3d.enabled&&Pe()})),$c(!L.grid3d.enabled)}{const n=document.getElementById("density"),t=document.getElementById("density-value");n&&(n.value=L.density.toFixed(2),t&&(t.textContent=L.density.toFixed(2)),n.addEventListener("input",()=>{t&&(t.textContent=parseFloat(n.value).toFixed(2))}),n.addEventListener("change",()=>{const e=parseFloat(n.value);Number.isFinite(e)&&(L.density=Math.max(cl,Math.min(hl,e)),localStorage.setItem(ws,String(L.density)),Pe())}))}{const n=document.getElementById("palette-select");n&&(n.innerHTML="",Hi.forEach(t=>{const e=document.createElement("option");e.value=t.name,e.textContent=t.name,n.appendChild(e)}),n.value=L.paletteName,n.addEventListener("change",()=>{L.paletteName=n.value,localStorage.setItem(Ji,L.paletteName),ml(),Pe()}))}function ml(){var e;const n=document.getElementById("tone-toggle");if(!n)return;const t=zr(L.paletteName);n.disabled=!Ss(t),n.checked=L.paletteTone==="light",(e=n.parentElement)==null||e.classList.toggle("disabled",!Ss(t))}{const n=document.getElementById("tone-toggle");n&&n.addEventListener("change",()=>{L.paletteTone=n.checked?"light":"dark",localStorage.setItem(Yr,L.paletteTone),Pe()}),ml()}{const n=document.getElementById("bg-select");n&&(n.value=L.bgKey,n.addEventListener("change",()=>{L.bgKey=n.value,localStorage.setItem(Xr,L.bgKey),ul(),fl(Kr())}))}{const n=document.getElementById("view-rotate");n&&(n.checked=L.autoRotate,n.addEventListener("change",()=>{L.autoRotate=n.checked,ye.autoRotate=L.autoRotate}));const t=document.getElementById("view-finder");t&&(t.checked=L.viewfinderVisible,t.addEventListener("change",()=>{L.viewfinderVisible=t.checked,localStorage.setItem(il,L.viewfinderVisible?"1":"0"),Is()}));const e=document.getElementById("view-advanced-anim");e&&(e.checked=L.advancedAnim,e.addEventListener("change",()=>{L.advancedAnim=e.checked,hu.value=L.advancedAnim?1:0,localStorage.setItem(ou,L.advancedAnim?"1":"0")}))}function za(){const n=al(),t=document.getElementById("export-dims-display");t&&(t.textContent=`${n.width} × ${n.height}`)}{const n=document.getElementById("aspect-select");if(n){n.innerHTML="";for(const e of Object.keys(gi)){const i=document.createElement("option");i.value=e,i.textContent=e,n.appendChild(i)}n.value=L.aspectKey,n.addEventListener("change",()=>{gi[n.value]&&(L.aspectKey=n.value,localStorage.setItem(ru,L.aspectKey),za(),Is())})}const t=document.getElementById("res-select");if(t){t.innerHTML="";for(const e of Object.keys(_i)){const i=document.createElement("option");i.value=e,i.textContent=`${e}px long edge`,t.appendChild(i)}t.value=L.resolutionKey,t.addEventListener("change",()=>{_i[t.value]&&(L.resolutionKey=t.value,localStorage.setItem(au,L.resolutionKey),za())})}za()}var jc,Qc;(jc=document.getElementById("save-png"))==null||jc.addEventListener("click",()=>gu()),(Qc=document.getElementById("save-gif"))==null||Qc.addEventListener("click",()=>_u());{let s=function(r){n&&(n.classList.toggle("collapsed",r),localStorage.setItem(qc,r?"collapsed":"open"))};const n=document.getElementById("settings-panel"),t=document.getElementById("settings-toggle"),e=document.getElementById("settings-close"),i=localStorage.getItem(qc)==="collapsed";n&&i&&n.classList.add("collapsed"),t==null||t.addEventListener("click",()=>{s(!n.classList.contains("collapsed"))}),e==null||e.addEventListener("click",()=>s(!0))}function ii(){const n=document.getElementById("palette-select");n&&(n.value=L.paletteName),ml();const t=document.getElementById("bg-select");t&&(t.value=L.bgKey);const e=document.getElementById("density"),i=document.getElementById("density-value");e&&(e.value=L.density.toFixed(2)),i&&(i.textContent=L.density.toFixed(2));const s=document.getElementById("view-rotate");s&&(s.checked=L.autoRotate);const r=document.getElementById("view-finder");r&&(r.checked=L.viewfinderVisible);const a=document.getElementById("view-advanced-anim");a&&(a.checked=L.advancedAnim)}function Jx(){const n=(t,e,i)=>{const s=document.getElementById(t),r=document.getElementById(e),a=i.toFixed(1);s&&(s.value=a),r&&(r.textContent=a)};n("size-height","size-height-value",L.size.h),n("size-width","size-width-value",L.size.w),n("size-depth","size-depth-value",L.size.d)}function vu(){L.masterSeed=Br();const n=Hi[Math.floor(Math.random()*Hi.length)];if(L.paletteName=n.name,Ss(n))L.bgKey=hi[Math.floor(Math.random()*hi.length)];else{const r=Er(n.paper),a=r>150,o=hi.filter(c=>{const h=Ps[c],f=h.color?Er(h.color):r;return a?f>150:f<150}),l=o.length>0?o:hi;L.bgKey=l[Math.floor(Math.random()*l.length)]}if(localStorage.setItem(Xr,L.bgKey),Ss(n)){const r=Ps[L.bgKey],a=r.color?Er(r.color):128;a<100?L.paletteTone="light":a>175?L.paletteTone="dark":L.paletteTone=Math.random()<.5?"light":"dark"}else L.paletteTone="dark";localStorage.setItem(Ji,L.paletteName),localStorage.setItem(Yr,L.paletteTone);const t=.25,e=.85;L.density=Math.round((t+Math.random()*(e-t))*20)/20,localStorage.setItem(ws,String(L.density));const i=new Set;for(const r of Ge)Math.random()<.65&&i.add(r);i.size===0&&i.add(Ge[Math.floor(Math.random()*Ge.length)]),L.vocabActive=i,Zr();const s=(r,a)=>Math.round((r+Math.random()*(a-r))*10)/10;L.size.w=s(Rs,Cs),L.size.h=s(ol,ll),L.size.d=s(Rs,Cs),localStorage.setItem(el,String(L.size.w)),localStorage.setItem(tl,String(L.size.h)),localStorage.setItem(nl,String(L.size.d)),dl(),Us(),ii(),Jx(),Pe(),Kn("RANDOMIZED ALL")}var th;(th=document.getElementById("btn-randomize-all"))==null||th.addEventListener("click",()=>vu());var eh;(eh=document.getElementById("btn-new-seed"))==null||eh.addEventListener("click",()=>{L.masterSeed=Br(),Pe()});window.addEventListener("keydown",n=>{const t=document.activeElement;if(t&&(t.tagName==="INPUT"||t.tagName==="TEXTAREA"))return;const e=n.key.toLowerCase();if(n.code==="Space"){n.shiftKey?vu():(L.masterSeed=Br(),Pe()),n.preventDefault();return}if(e==="c"){const s=Hi.findIndex(r=>r.name===L.paletteName);L.paletteName=Hi[(s+1)%Hi.length].name,localStorage.setItem(Ji,L.paletteName),Pe(),ii();return}if(e==="b"){const s=hi.indexOf(L.bgKey);L.bgKey=hi[(s+1)%hi.length],localStorage.setItem(Xr,L.bgKey),ul(),fl(Kr()),ii();return}if(e==="r"){L.autoRotate=!L.autoRotate,ye.autoRotate=L.autoRotate,ii();return}if(e==="s"){gu();return}if(e==="g"){_u();return}if(e==="v"){L.viewfinderVisible=!L.viewfinderVisible,localStorage.setItem(il,L.viewfinderVisible?"1":"0"),Is(),ii();return}const i="12345".indexOf(e);if(i>=0){const s=Ge[i];n.shiftKey?Mu(s):Su(s);return}if(e==="0"){jx();return}e==="+"||e==="="?(L.density=Math.min(hl,L.density+.05),localStorage.setItem(ws,String(L.density)),Pe(),ii()):(e==="-"||e==="_")&&(L.density=Math.max(cl,L.density-.05),localStorage.setItem(ws,String(L.density)),Pe(),ii())});function Zr(){localStorage.setItem(su,JSON.stringify([...L.vocabActive]))}function Su(n){if(Ge.includes(n)){if(L.vocabActive.has(n)){if(L.vocabActive.size===1)return;L.vocabActive.delete(n)}else L.vocabActive.add(n);Zr(),Us(),Pe()}}function Mu(n){Ge.includes(n)&&(L.vocabActive=new Set([n]),Zr(),Us(),Pe())}function jx(){L.vocabActive=new Set(Ge),Zr(),Us(),Pe()}function Us(){for(const n of Ge){const t=document.querySelector(`.vocab-toggle[data-vocab="${n}"]`);t&&t.classList.toggle("active",L.vocabActive.has(n))}}function Qx(){return L.vocabActive.size===Ge.length?"all":L.vocabActive.size===1?[...L.vocabActive][0]:[...L.vocabActive].join("+")}document.querySelectorAll(".vocab-toggle").forEach(n=>{n.addEventListener("click",t=>{const e=n.dataset.vocab;t.shiftKey?Mu(e):Su(e)})});const yu=new Id,ui=90,we={frameTimes:new Float32Array(ui),frameIdx:0,smoothedFps:60,lastFrame:performance.now(),lastUiUpdate:0,spriteCount:0};function tv(){var a,o,l;const n=performance.now(),t=n-we.lastFrame;if(we.lastFrame=n,we.frameTimes[we.frameIdx]=t,we.frameIdx=(we.frameIdx+1)%ui,t>0&&t<200&&(we.smoothedFps=we.smoothedFps*.92+1e3/t*.08),n-we.lastUiUpdate<250)return;we.lastUiUpdate=n;const e=vi.info,i=we.frameTimes[(we.frameIdx-1+ui)%ui];let s=0;for(let c=0;c<L.instancedMeshes.length;c++)s+=L.instancedMeshes[c].count;let r=0;for(let c=0;c<L.mergedLines.length;c++){const h=L.mergedLines[c].mesh;r+=((l=(o=(a=h.geometry)==null?void 0:a.attributes)==null?void 0:o.position)==null?void 0:l.count)??0}un("profile-fps",we.smoothedFps.toFixed(1)),un("profile-frametime",`${i.toFixed(1)} ms`),un("profile-draws",String(e.render.calls)),un("profile-tris",Jc(e.render.triangles)),un("profile-geos",String(e.memory.geometries)),un("profile-texs",String(e.memory.textures)),un("profile-inst",String(s)),un("profile-lines",Jc(r)),un("profile-anim",String(L.animatedElements.length)),un("profile-sprites",String(we.spriteCount)),ev()}function un(n,t){const e=document.getElementById(n);e&&(e.textContent=t)}function Jc(n){return n<1e3?String(n):n<1e4?(n/1e3).toFixed(1)+"k":Math.round(n/1e3)+"k"}function ev(){const n=document.getElementById("profile-sparkline");if(!n)return;const t=n.getContext("2d"),e=n.width,i=n.height;t.clearRect(0,0,e,i);const s=50,r=i-16.67/s*i;t.strokeStyle="rgba(212, 40, 42, 0.55)",t.lineWidth=1,t.setLineDash([3,3]),t.beginPath(),t.moveTo(0,r),t.lineTo(e,r),t.stroke(),t.setLineDash([]),t.strokeStyle="rgba(239, 233, 216, 0.9)",t.lineWidth=1.2,t.beginPath();for(let a=0;a<ui;a++){const o=(we.frameIdx+a)%ui,l=we.frameTimes[o],c=a/(ui-1)*e,h=i-Math.min(i,l/s*i);a===0?t.moveTo(c,h):t.lineTo(c,h)}t.stroke()}function nv(){var t;let n=0;(t=L.cuboidGroup)==null||t.traverse(e=>{e.isSprite&&n++}),we.spriteCount=n}function Eu(){requestAnimationFrame(Eu),L.isExporting||(Fr(yu.getElapsedTime()),ye.update(),vi.render($n,Re),tv())}Us();Is();Pe();Zx();Eu();
